...
export default function Footer(props) {
  ...
  return (
    <footer className="py-6 bg-coolGray-100 text-coolGray-900 bg-gray-800 text-white">
        ...
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-3 ">
            ...
            <div className="grid grid-cols-3 gap-2">
              {arrHeThongRap.map((itemHeThong, index) => {
                return <div key={index}>
                  <img style={{ width: 30 }} src={itemHeThong.logo} alt={itemHeThong.tenHeThongRap} />
                </div>
              })}
            </div>
          </div>
